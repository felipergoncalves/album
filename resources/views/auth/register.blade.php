...
<div class="container-fluid h-100">
    <div class="row h-100 justify-content-md-center">
        ...
        <!-- Coluna de login -->
        <div class="col-12 col-lg-8 col-xl-5 align-self-center text-center p-5">
            <h1 class="display-3 text-pacifico">Bem Vindo!</h1>
            <br>
            <p>Utilze o seu e-mail e senha para acessar o painel adminstrativo</p>
            ...
            <hr>
            <br>
            <p>Já possui uma conta? <a href="">FAÇA LOGIN AQUI</a></p>
        </div>
    </div><!-- row-->
</div><!-- container -->
